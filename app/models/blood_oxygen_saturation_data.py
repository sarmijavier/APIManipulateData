...
class BloodOxygenSaturationData(db.Model, SerializerMixin, CustomSerializer):

	__tablename__ = 'blood_oxygen_saturation_data'
	...
	fields = ['id','avg', 'min', 'max', 'complete_date', 'user_id', 'created_at', 'updated_at']

	def __repr__(self):
		return f'<BloodOxygenSaturationData {self.id}.>'